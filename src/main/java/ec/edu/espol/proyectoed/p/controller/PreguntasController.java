...
public class PreguntasController implements Initializable{
    ...
    void btnEmpezar(ActionEvent event) {
        ...
        if(entrada.isEmpty()){
            Util.mostrarAlerta("Error", "No hay contenido en el cuadro de texto. Por favor ingrese un número de preguntas en el rango de 1 a " + preguntasArchivo + ".");
        }else{
            ...
            if(preguntasDentroRango(numPreguntas,preguntasArchivo)){
                ...
                Util.mostrarAlerta("Error", "El número de preguntas no está en el rango de 1 a " + preguntasArchivo + ".");
            }
        }
    }
